    ...
    <section for="Header">
        <div style="background-color:black; width: 100%;">
            <div class="container" style="padding-top: 0px;">          
                <div class="row">
                    <div class="col-3">
                    <button type="button" class="btn btn-xs" style="background:#FF7D3F;color:white;margin-top: 30px;margin-left:-70px" id="back">Back</button>
                ...
                <div class="col-6">
                    ...
                    <form action="<?php echo base_url("form/form/process") ?>" method="post" class="form-horizontal" id="regForm" enctype="multipart/form-data">
                        ...
                        <section for="step 1" class="step1 <?php echo (isset($_SESSION['applicationID']) && !empty($_SESSION['applicationID'])) ? 'd-none' : '' ?> ">
                            ...
                            <div class="col">
                                <input type="text" class="form-control imcn" id="phone" minlength="12" maxlength="12" name="phone" pattern="\(\d{3}\)-\d{3}-\d{4}" placeholder="000-000-0000">
                            </div>
                            <div class="col mt-3">
                                <span class="qxtheme">
                                    <p class="lableTxt">
                            ...
                            <div class="col">
                                <input type="text" class="form-control" id="fill_by" name="fill_by" readonly placeholder="Enter Filled by" value="Admin" autocomplete="off">
                            </div>
                            <div class="col mt-3">
                                <span class="qxtheme">
                                    <p class="lableTxt">
                            ...
                            <input name="fill" type="hidden" value="admin" />
                        ...
                        <section for="step 2" class="step2 d-none">
                            ...
                            <div class="row">
                                <div class="col mt-2 lableTxt">Filled By:</div>
                                <div class="col mt-2 lableTxt text-start"><span class="FillByPre"></span></div>
                            </div>
                        ...
                        <section for="step 3" class="step3 d-none">
                            ...
                            <div class="row">
                                ...
                                <div class="col mt-2 secThree" style="text-align:center">
                                    <input type="submit" class="btn btn-block btn-md btns" Value="Continue" />
                                </div>
                            </div>
                        ...
                        <section for="step 4" class="step4 text-center <?php echo (isset($_SESSION['applicationID']) || !empty($_SESSION['applicationID'])) ? 'aaaa' : 'd-none' ?>">
                            ...
                            <div class="col mt-2">
                                <a href="<?php echo base_url() ?>" class="btn btn-block btn-lg btns submitForm">Finish</a>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".secOne").click(function() {
                ...
                if ($("#fill_by").val() == "") {
                    $("#fill_by").parent().append('<span id="fill_byerror" class="errorcode">Enter Filled by</span>');
                    $("html,body").animate({
                        scrollTop: 400
                    }, 1000);
                    return false;
        ...
        $(document).ready(function() {
         ...
         document.getElementById('upload').addEventListener('change', function() {
            ...
            var maxFileSizeMB = 50; // Maximum file size in megabytes
            ...
            if (allowedExtensions.indexOf(fileExtension) === -1) {
                ...
                alert('File size exceeds the maximum allowed size of ' + maxFileSizeMB + 'MB.');
                this.value = ""; // Clear the input field
            }
        });
        //-------End File Validation-----------------   q
    </script>
