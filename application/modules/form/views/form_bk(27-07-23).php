        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <hr style="margin-right: 7%;margin-top: 6%;">
                    <form action="<?php echo base_url("form/form/process") ?>" method="post" class="form-horizontal" id="regForm" enctype="multipart/form-data">
                        ...
                        <section for="step 1" class="step1 <?php echo (isset($_SESSION['applicationID']) && !empty($_SESSION['applicationID'])) ? 'd-none' : '' ?> ">
                            ...
                            <div class="col mt-2">
                                <select name="gender" class="dselect form-control">
                            ...
                            <div class="row">
                                <div class="col-6 mt-2">
                                    ...
                                    <input type="text" class="form-control" maxlength="15" isvalid="1" placeholder="Driver’s License Number" name="license">
                                </div>
                                ...
                                <div class="col-5 mt-2">
                                    <span class=" qxtheme">
                                        <p class="lableTxt">State Identification Number</p><span>
                                            <input type="text" class="form-control" isvalid="1" placeholder="State Identification Number" name="state_id_no">
                                </div>
                            </div>
                            ...
                            <div class="col mt-2 d-flax">
                                <select name="issuing_state" id="issuing_state" class="form-control">
                                    <option value="">State</option>
                                    <?php if (!empty($state)) {
                                        foreach ($state as $val) { ?>
                                            <option value="<?php echo $val->name ?>"><?php echo $val->name ?></option>
                        ...
                        <section for="step 4" class="step4 text-center <?php echo (isset($_SESSION['applicationID']) && !empty($_SESSION['applicationID'])) ? '' : 'd-none' ?>">
                            <div class="col mt-2">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".secOne").click(function() {
                ...
                var cityStateZipe = $("#city").val() + " / " + $("#state").val() + " / " + $("#postcode").val() + "/ " + $("issuing_state");
