...
class User extends MY_Controller
{
   ...
   public function index()
   {
      ...
      $params["results"] = $this->User_model->getuserrole();
      //echo '<pre>';print_r($params["results"]);die;
      $this->load->view('header');
      $this->load->view('navbar', $params);
      $this->load->view('user/userrole_page', $params);
      $this->load->view('footer');
   }
   

   function view_userdetail($id = 0)
   {
      ...
      $this->load->view("user/view_userdetail", $params);
      $this->load->view('footer');
   }
   ...
   // {
   //    $res = $this->User_model->updatestatus($this->input->post('status'), $this->input->post('id'));
   //    return true;
   // }
   // function updatecomment()
   // {

   //    $res = $this->User_model->updatecomment($this->input->post('textcomment'), $this->input->post('id'));
   //    return true;
   // }
